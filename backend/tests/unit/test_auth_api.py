...
class TestAuthApi:
    ...
    def test_register_validation(self, test_client, user_data, expected_status, monkeypatch):
    ...
    def test_login(self, test_client, mock_user, mock_token, credentials, auth_success, expected_status, monkeypatch):
        ...
        if auth_success:
            ...
            if expected_status == status.HTTP_401_UNAUTHORIZED:
                mock_authenticate = AsyncMock(side_effect=HTTPException(
    ...
    def test_refresh_token(self, test_client, mock_token, auth_header, refresh_success, expected_status, monkeypatch):
        ...
        if refresh_success:
            ...
            mock_refresh = AsyncMock(side_effect=HTTPException(
                status_code=status.HTTP_401_UNAUTHORIZED,
