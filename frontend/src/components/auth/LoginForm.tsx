            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex flex-col gap-4 pt-2">
                ...
                <div className="text-center space-y-3 pt-2">
                  <RouterLink
                    to="/reset-password"
                    className="text-sm text-muted-foreground hover:text-brandGreen transition-colors"
                  >
                    Zapomniałeś hasła?
                  </RouterLink>
                  <div className="text-sm">
                    ...
                    <RouterLink
                      to="/register"
                      className="text-brandGreen font-medium hover:text-brandGreen/80 transition-colors"
                    >
                      Zarejestruj się
                    </RouterLink>
                  </div>
