import { Card, CardContent, CardDescription, CardHeader, CardTitle, ThemedCard } from '@/components/ui/card';
    ...
    <div className="space-y-8">
      <div className="relative pb-3 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-20 after:bg-gradient-to-r after:from-brandGreen after:to-brandLime after:rounded-full">
        ...
        <p className="text-muted-foreground mt-2">
          Witaj z powrotem, <span className="text-brandGreen font-medium">{user?.first_name}</span>! Oto przegląd Twoich podróży i list pakowania.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <ThemedCard variant="primary">
          ...
          <CardContent>
            ...
            <Button variant="ghost" className="mt-4 text-xs w-full justify-start hover:bg-brandGreen/10 border border-transparent hover:border-brandGreen/20">
              Zaplanuj podróż →
            </Button>
          </CardContent>
        </ThemedCard>
        ...
        <ThemedCard variant="secondary">
          ...
          <CardContent>
            ...
            <Button variant="ghost" className="mt-4 text-xs w-full justify-start hover:bg-brandLime/10 border border-transparent hover:border-brandLime/20">
              Stwórz listę →
            </Button>
          </CardContent>
        </ThemedCard>
        ...
        <ThemedCard variant="accent">
          ...
          <CardContent>
            ...
            <Button variant="ghost" className="mt-4 text-xs w-full justify-start hover:bg-brandPink/10 border border-transparent hover:border-brandPink/20">
              Zobacz historię →
            </Button>
          </CardContent>
        </ThemedCard>
        ...
        <CardContent>
          <div className="rounded-md bg-grayPurple/5 border border-grayPurple/10 p-4 flex items-center">
            <div className="w-10 h-10 rounded-full bg-gradient-to-r from-brandGreen/20 to-brandLime/20 flex items-center justify-center mr-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-brandGreen">
                <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"></path>
              </svg>
            </div>
            <div>
              <p className="text-sm">Brak ostatniej aktywności</p>
              <p className="text-xs text-muted-foreground mt-1">Tutaj będą wyświetlane Twoje ostatnie działania</p>
            </div>
          </div>
        </CardContent>
      </ThemedCard>
